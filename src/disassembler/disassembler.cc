...
///         //根据不同的func码找到对应的指令，按指令的规范得到汇编语言
///         ins = FUNCT_TO_INSTRUCTION.at(func) + rs / rt /rd /shamt
///     else opcode不等于0b000000
///         //该指令为I型指令或J型指令，需通过op码进行区分
///         for I型指令 get rs,rt and imm
///         ins = OPCODE_TO_INSTRUCTION.at(opcode) + rs + rt + imm
///         for J型指令 get address
